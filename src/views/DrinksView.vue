<template>
    <div class="home">
        <div class="flex overflow-scroll sticky top-0 left-0 bg-white z-[99] bg-opacity-60 mt-3" id="menu-drinks">
        ...
        updateScrollPosition() {
            ...
            if (document.getElementById('menu-drinks') != null) {
                if (this.scrollPosition > 160 && this.$route.name == 'drinks') {
                    document.getElementById('menu-drinks').style.backgroundColor = 'rgba(255, 255, 255, 1)';
                } else {
                    document.getElementById('menu-drinks').style.backgroundColor = 'rgba(255, 255, 255, 0.6)';
                }
            }
